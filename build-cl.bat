...
SET CommonCompilerFlags=-Od -nologo -fp:fast -fp:except- -Gm- -GR- -EHa- -Zo -FC -Z7 -TC -I %GLEWIncludePath% -I %GLFWIncludePath% -I %GLMIncludePath% -I %STBIncludePath% -I %SHLIncludePath% -I %NVGIncludePath% -D _DEBUG -W2
