...
* [ ] When Sally Shears cheat is enabled and the disabled the goldmines are shown in the minimap, even though no units was near them.
* [ ] When selected an enemy unit, the cursor change to red or yello crosshair when hover another unit.
