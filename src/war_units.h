...
const WarUnitCommandBaseData commandBaseData[] = 
{
    ...
    // build commands
    { WAR_COMMAND_BUILD_FARM_HUMANS,        NULL,                    6, "BUILD FARM"                },
    { WAR_COMMAND_BUILD_FARM_ORCS,          NULL,                    6, "BUILD FARM"                },
    { WAR_COMMAND_BUILD_BARRACKS_HUMANS,    NULL,                    6, "BUILD BARRACKS"            },
    { WAR_COMMAND_BUILD_BARRACKS_ORCS,      NULL,                    6, "BUILD BARRACKS"            },
    { WAR_COMMAND_BUILD_CHURCH,             NULL,                    8, "BUILD CHURCH"              },
    { WAR_COMMAND_BUILD_TEMPLE,             NULL,                    7, "BUILD TEMPLE"              },
    { WAR_COMMAND_BUILD_TOWER_HUMANS,       NULL,                    6, "BUILD TOWER"               },
    { WAR_COMMAND_BUILD_TOWER_ORCS,         NULL,                    6, "BUILD TOWER"               },
    { WAR_COMMAND_BUILD_TOWNHALL_HUMANS,    NULL,                   11, "BUILD TOWN HALL"           },
    { WAR_COMMAND_BUILD_TOWNHALL_ORCS,      NULL,                   11, "BUILD TOWN HALL"           },
    { WAR_COMMAND_BUILD_LUMBERMILL_HUMANS,  NULL,                    6, "BUILD LUMBER MILL"         },
    { WAR_COMMAND_BUILD_LUMBERMILL_ORCS,    NULL,                    6, "BUILD LUMBER MILL"         },
    { WAR_COMMAND_BUILD_STABLE,             NULL,                    6, "BUILD STABLES"             },
    { WAR_COMMAND_BUILD_KENNEL,             NULL,                    6, "BUILD KENNEL"              },
    { WAR_COMMAND_BUILD_BLACKSMITH_HUMANS,  NULL,                    6, "BUILD BLACKSMITH"          },
    { WAR_COMMAND_BUILD_BLACKSMITH_ORCS,    NULL,                    6, "BUILD BLACKSMITH"          },
