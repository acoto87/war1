...
#define FONT_NORMAL_COLOR_INIT WAR_COLOR_PACKED_INIT(0xFFDBFFEF)
#define FONT_NORMAL_COLOR WAR_COLOR_PACKED(0xFFDBFFEF)

#define FONT_HIGHLIGHT_COLOR_INIT WAR_COLOR_PACKED_INIT(0xFF49E3FF)
#define FONT_HIGHLIGHT_COLOR WAR_COLOR_PACKED(0xFF49E3FF)
