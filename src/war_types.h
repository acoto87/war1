...
typedef enum
{
    ...
    WAR_LOGO = 472,
    WAR_INTRO_DOOR = 473,
    WAR_MISC_BUILDING = 474,
    WAR_MISC_EXPLOSION = 475,
    WAR_MISSILES_CATAPULT_ROCK_FIRED = 476,
    WAR_MISC_TREE_CHOPPING_1 = 477,
    WAR_MISC_TREE_CHOPPING_2 = 478,
    WAR_MISC_TREE_CHOPPING_3 = 479,
    WAR_MISC_TREE_CHOPPING_4 = 480,
    WAR_MISC_BUILDING_COLLAPSE_1 = 481,
    WAR_MISC_BUILDING_COLLAPSE_2 = 482,
    WAR_MISC_BUILDING_COLLAPSE_3 = 483,
    WAR_UI_CHIME = 484,
    WAR_UI_CLICK = 485,
    WAR_UI_CANCEL = 486,
    WAR_MISSILES_SWORD_ATTACK_1 = 487,
    WAR_MISSILES_SWORD_ATTACK_2 = 488,
    WAR_MISSILES_SWORD_ATTACK_3 = 489,
    WAR_MISSILES_FIST_ATTACK = 490,
    WAR_MISSILES_CATAPULT_FIRE_EXPLOSION = 491,
    WAR_MISSILES_FIREBALL = 492,
    WAR_MISSILES_ARROW_SPEAR = 493,
    WAR_MISSILES_ARROW_SPEAR_HIT = 494,
    WAR_ORC_HELP_1 = 495,
    WAR_ORC_HELP_2 = 496,
    WAR_HUMAN_HELP_2 = 497,
    WAR_HUMAN_HELP_1 = 498,
    WAR_ORC_DEAD = 499,
    WAR_HUMAN_DEAD = 500,
    WAR_ORC_WORK_COMPLETE = 501,
    WAR_HUMAN_WORK_COMPLETE = 502,
    WAR_ORC_HELP_3 = 503,
    WAR_ORC_HELP_4 = 504,
    WAR_HUMAN_HELP_3 = 505,
    WAR_HUMAN_HELP_4 = 506,
    WAR_ORC_READY = 507,
    WAR_HUMAN_READY = 508,
    ...
    WAR_HUMAN_ACKNOWLEDGEMENT_1 = 513,
    WAR_HUMAN_ACKNOWLEDGEMENT_2 = 514,
    WAR_ORC_SELECTED_1 = 515,
    WAR_ORC_SELECTED_2 = 516,
    WAR_ORC_SELECTED_3 = 517,
    WAR_ORC_SELECTED_4 = 518,
    WAR_ORC_SELECTED_5 = 519,
    WAR_HUMAN_SELECTED_1 = 520,
    WAR_HUMAN_SELECTED_2 = 521,
    WAR_HUMAN_SELECTED_3 = 522,
    WAR_HUMAN_SELECTED_4 = 523,
    WAR_HUMAN_SELECTED_5 = 524,
    WAR_ORC_ANNOYED_1 = 525,
    WAR_ORC_ANNOYED_2 = 526,
    WAR_ORC_ANNOYED_3 = 527,
    WAR_HUMAN_ANNOYED_1 = 528,
    WAR_HUMAN_ANNOYED_2 = 529,
    WAR_HUMAN_ANNOYED_3 = 530,
    WAR_DEAD_SPIDER_SCORPION = 531,
    WAR_NORMAL_SPELL = 532,
    WAR_MISC_BUILD_ROAD = 533,
    WAR_ORC_TEMPLE = 534,
    WAR_HUMAN_CHURCH = 535,
    WAR_ORC_KENNEL = 536,
    WAR_HUMAN_STABLE = 537,
    WAR_BLACKSMITH = 538,
    WAR_MISC_FIRE_CRACKLING = 539,
    WAR_CANNON = 540,
    WAR_CANNON2 = 541,
    ...
    WAR_HUMAN_DEFEAT = 575,
    WAR_ORC_DEFEAT = 576,
    WAR_ORC_VICTORY_1 = 577,
    WAR_ORC_VICTORY_2 = 578,
    WAR_ORC_VICTORY_3 = 579,
    WAR_HUMAN_VICTORY_1 = 580,
    WAR_HUMAN_VICTORY_2 = 581,
    WAR_HUMAN_VICTORY_3 = 582,
} WarAudioId;
