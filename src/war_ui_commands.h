...
void executeInvisiblityUICommand(WarContext* context, WarEntity* targetEntity, vec2 targetTile);
void executeUnholyArmorUICommand(WarContext* context, WarEntity* targetEntity, vec2 targetTile);
void executeRaiseDeadUICommand(WarContext* context, vec2 targetTile);
void executeSightUICommand(WarContext* context, vec2 targetTile);
